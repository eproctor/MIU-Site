...
/* ========== Function to Search Data on jSearch - Add Contacts Tab ========== */



// Grab the data out of local Storage;
//var startSearch = function() {
$("#jsearchAddBut").click(function() {
//alert ("Hello");
	
							var newDiv = document.createElement("div");
							var viewList = document.getElementById("jclearScreenAddContacts");
	...
	if (pageSearchAddContact.value != "") {


		//alert("Hello");
		//console.log (pageSearchAddContact.value);
		...
		for (var i=0, len=localStorage.length; i<len; i++) {
				...
				//console.log (contact[n][0] + "  " +contact[n][1]); // temporary for testing
					...
					if (pageSearchAddContact.value === contact[n][1]) {
//					alert (contact[n][1]);
					console.log (pageSearchAddContact.value + " and " + contact[n] [1]);
//					
						for (var q in contact) {
...
//			
	...
	} else { alert ("There is no entry for " + " '  " + pageSearchAddContact.value + "   ' "); }
...
var pageSearchAddContact = docGetId("jboxSearchAdd");
